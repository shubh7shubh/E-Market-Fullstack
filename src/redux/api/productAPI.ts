...
import { AllProductsResponse, CategoriesResponse, LatestProductsResponse, NewProductRequest, SearchProductsRequest, SearchProductsResponse } from "../../types/api-types";
...
export const productAPI = createApi({
    ...
    endpoints: (builder) => ({
        ...
        newProduct: builder.mutation<AllProductsResponse, NewProductRequest>({
            query: ({ formData, id }) => ({
                url: `new?id=${id}`,
                method: "POST",
                body: formData
